#ifndef VL53L0X_mod_h
#define VL53L0X_mod_h

#include <Arduino.h>
#include <Wire.h>


#define ST_START                0       // Initialize non-blocking reading.    // <----------------------------------------------------------------HERE
#define ST_WAIT_START           1       // Wait for the sensor to start reading.   // <----------------------------------------------------------------HERE
