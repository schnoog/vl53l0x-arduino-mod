...
This is a fork of Pololus library which incorporated the PR by jjsch-dev to enable a non blocking reading of the sensor.
I'm aware that other libraries offer that also, but this one has the smallest footprint in regards to program storage usage
...
* `bool VL53L0X::readRangeNoBlocking(uint16_t& range)`<br>
  Returns true if measurement is completed. Range of 65535 indicates timeout.
...
* 1.0.0 (2023-05-07): For into new repo, PR to enable non blocking reading
* --------
